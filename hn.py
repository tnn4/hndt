...
def get_stories(calls_per_hour=CALLS_PER_HR):
...
def cache_all_items(calls_per_hour=CALLS_PER_HR, start_from='newest', end=None):
    """
...
def cache_posts(route, calls_per_hr=CALLS_PER_HR):
    """
